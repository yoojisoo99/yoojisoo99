...
| 프로젝트 | 설명 | 링크 |
|---|---|---|
| **가상계좌 결제 시스템** | 3-Tier 망분리 구조 설계, Terraform으로 VPC·EKS·RDS·ElastiCache 코드화, GitHub Actions·ArgoCD GitOps 파이프라인 구축 (5인 팀 중 인프라 단독 설계, 8일) | [Repo](https://github.com/yoojisoo99/mini_PJT3_Infra) |
